  ...
  return (
    <main className="min-h-screen bg-[#F4F7FB] px-6 py-16 text-night lg:px-16">
      <section className="mx-auto max-w-6xl">
        ...
        <h1 className="mt-6 text-5xl font-black">Des offres simples pour lancer EnterpriseERP Cloud.</h1>
        <p className="mt-4 max-w-3xl text-lg leading-8 text-slate-600">
          L'essai gratuit donne un cadre clair: 14 jours, admin complet, 3 utilisateurs,
          20 factures, 50 produits, puis lecture seule jusqu'au paiement.
        </p>
