...
export const navigationItems: NavigationItem[] = [
  ...
  { key: "comptabilite", name: "Comptabilité", href: "/comptabilite", icon: "AC" },
  { key: "rh", name: "Employés", href: "/rh", icon: "HR" },
  ...
  { key: "roles-permissions", name: "Rôles & permissions", href: moduleHref("roles-permissions"), icon: "RB" },
  ...
  { key: "reservations", name: "Réservations", href: moduleHref("reservations"), icon: "RS" },
  ...
  { key: "materiels", name: "Matériels", href: moduleHref("materiels"), icon: "EQ" },
  { key: "materiaux", name: "Matériaux", href: moduleHref("materiaux"), icon: "MT" },
  { key: "budgets", name: "Budgets", href: moduleHref("budgets"), icon: "BU" },
  { key: "patients", name: "Patients", href: moduleHref("patients"), icon: "PA" },
  { key: "medecins", name: "Médecins", href: moduleHref("medecins"), icon: "DR" },
  ...
  { key: "dossiers-medicaux", name: "Dossiers médicaux", href: moduleHref("dossiers-medicaux"), icon: "DM" },
  { key: "etudiants", name: "Étudiants", href: moduleHref("etudiants"), icon: "ET" },
  ...
  { key: "presences", name: "Présences", href: moduleHref("presences"), icon: "AT" },
  ...
  { key: "expeditions", name: "Expéditions", href: moduleHref("expeditions"), icon: "SH" },
  { key: "itineraires", name: "Itinéraires", href: moduleHref("itineraires"), icon: "RO" },
  ...
  { key: "matieres-premieres", name: "Matières premières", href: moduleHref("matieres-premieres"), icon: "RM" },
  ...
  { key: "parametres", name: "Paramètres", href: "/parametres", icon: "SE" },
];
