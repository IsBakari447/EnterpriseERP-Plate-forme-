...
export const sectorDashboards: Record<SectorKey, SectorDashboard> = {
  ...
  hospitality: {
    ...
    kpis: [
      ...
      { label: "Occupation", baseValue: 81, format: "percent", change: "+5 pts" },
    ...
    priorities: [
      ...
      { title: "Unites a nettoyer", detail: "12 chambres ou biens en attente", impact: "Disponibilite", action: "Assigner", tone: "red" },
      { title: "Paiements a encaisser", detail: "9 sejours non soldes", impact: "Tresorerie", action: "Encaisser", tone: "cyan" },
      { title: "Disponibilites", detail: "4 conflits calendrier a verifier", impact: "Reservations", action: "Verifier", tone: "green" },
    ],
    cashflow: sharedDashboard.cashflow,
    activity: sharedDashboard.activity,
    moduleStats: [
      { module: "Reservations", metric: "Confirmees", value: "224", trend: "+12%", status: "Actif" },
      { module: "Disponibilites", metric: "Occupation", value: "81%", trend: "+5 pts", status: "Actif" },
      { module: "Nettoyage", metric: "A planifier", value: "12", trend: "-4", status: "En attente" },
      { module: "Paiements", metric: "A encaisser", value: "11 300 EUR", trend: "+6%", status: "Actif" },
    ],
    alerts: ["12 unites attendent nettoyage.", "18 arrivees doivent etre preparees.", "9 sejours ne sont pas soldes.", "4 disponibilites doivent etre verifiees."],
    goals: [
  ...
  agriculture: {
    label: "Agriculture",
    kpis: [
      { label: "Parcelles actives", baseValue: 26, format: "number", change: "+4" },
      { label: "Recoltes prevues", baseValue: 184000, format: "currency", change: "+9%" },
      { label: "Stock intrants", baseValue: 72, format: "percent", change: "-6 pts" },
      { label: "Commandes", baseValue: 48, format: "number", change: "+8%" },
    ],
    priorities: [
      { title: "Intrants critiques", detail: "6 references sous seuil", impact: "Risque recolte", action: "Commander", tone: "red" },
      { title: "Traitements a planifier", detail: "9 parcelles a surveiller", impact: "Qualite", action: "Planifier", tone: "orange" },
      { title: "Recoltes proches", detail: "4 cultures arrivent a maturite", impact: "Logistique", action: "Organiser", tone: "cyan" },
      { title: "Ventes a confirmer", detail: "11 commandes en attente", impact: "Tresorerie", action: "Confirmer", tone: "green" },
    ],
    cashflow: sharedDashboard.cashflow,
    activity: sharedDashboard.activity,
    moduleStats: [
      { module: "Parcelles", metric: "Actives", value: "26", trend: "+4", status: "Actif" },
      { module: "Cultures", metric: "En cours", value: "18", trend: "+3", status: "Actif" },
      { module: "Intrants", metric: "Critiques", value: "6", trend: "+2", status: "Critique" },
      { module: "Recoltes", metric: "Prevues", value: "184 000 EUR", trend: "+9%", status: "Actif" },
    ],
    alerts: ["6 intrants sont sous le seuil.", "9 parcelles demandent un traitement.", "4 cultures arrivent a maturite.", "11 commandes agricoles attendent confirmation."],
    goals: [
      { label: "Rendement", progress: 76, current: "76%", target: "100%" },
      { label: "Stock intrants", progress: 72, current: "72%", target: "95%" },
      { label: "Recoltes planifiees", progress: 68, current: "4", target: "6" },
      { label: "Ventes confirmees", progress: 81, current: "39", target: "48" },
    ],
    ai: sharedDashboard.ai,
  },
  livestock: {
    label: "Elevage",
    kpis: [
      { label: "Animaux suivis", baseValue: 420, format: "number", change: "+18" },
      { label: "Production", baseValue: 28600, format: "currency", change: "+7%" },
      { label: "Soins ouverts", baseValue: 14, format: "number", change: "-3" },
      { label: "Stock aliments", baseValue: 68, format: "percent", change: "-8 pts" },
    ],
    priorities: [
      { title: "Alimentation", detail: "5 lots sous seuil", impact: "Production", action: "Commander", tone: "red" },
      { title: "Soins a valider", detail: "14 interventions ouvertes", impact: "Sante troupeau", action: "Planifier", tone: "orange" },
      { title: "Production a suivre", detail: "3 ecarts de rendement", impact: "Marge", action: "Analyser", tone: "cyan" },
      { title: "Ventes a facturer", detail: "8 livraisons terminees", impact: "Tresorerie", action: "Facturer", tone: "green" },
    ],
    cashflow: sharedDashboard.cashflow,
    activity: sharedDashboard.activity,
    moduleStats: [
      { module: "Animaux", metric: "Suivis", value: "420", trend: "+18", status: "Actif" },
      { module: "Alimentation", metric: "Stock", value: "68%", trend: "-8 pts", status: "Stock faible" },
      { module: "Soins", metric: "Ouverts", value: "14", trend: "-3", status: "En attente" },
      { module: "Production", metric: "Valeur", value: "28 600 EUR", trend: "+7%", status: "Actif" },
    ],
    alerts: ["5 lots d'alimentation sont sous seuil.", "14 soins restent ouverts.", "3 ecarts de production doivent etre analyses.", "8 livraisons doivent etre facturees."],
    goals: [
      { label: "Production mensuelle", progress: 73, current: "28 600 EUR", target: "39 000 EUR" },
      { label: "Soins traites", progress: 62, current: "24/38", target: "38/38" },
      { label: "Stock aliments", progress: 68, current: "68%", target: "95%" },
      { label: "Ventes facturees", progress: 79, current: "31", target: "39" },
    ],
    ai: sharedDashboard.ai,
  },
  hotel: {
