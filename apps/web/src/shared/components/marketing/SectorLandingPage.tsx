        ...
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-6 py-20 lg:grid-cols-2 lg:py-28">
          <div>
            ...
            <h1 className="mt-7 text-4xl font-extrabold leading-tight text-[#1E2A38] sm:text-5xl lg:text-6xl">
              {sector.title}{" "}
              <span className="text-[#00A990]">
                {sector.highlightedTitle}
              </span>
            </h1>
            ...
            <div className="relative rounded-[28px] border border-slate-200 bg-white p-3 shadow-2xl">
              <div className="rounded-3xl bg-[#101A26] p-6 text-white">
                <p className="text-sm text-slate-400">
                  {sector.dashboardTitle}
                </p>

                <h2 className="mt-2 text-2xl font-bold">
                  EnterpriseERP Dashboard
                </h2>
                ...
                <div className="mt-6 grid grid-cols-2 gap-4">
                  ...
                  <div className="rounded-2xl bg-white/10 p-4">
                    ...
                    <p className="mt-1 text-sm text-[#7FF2E1]">
                      Suivi centralisé
                    </p>
                  </div>
                </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-bold text-[#1E2A38] sm:text-4xl">
              Les défis qui ralentissent votre activité
            </h2>
      ...
      <section id="modules" className="py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-bold text-[#1E2A38] sm:text-4xl">
              Une plateforme adaptée à votre secteur
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-bold sm:text-4xl">
              Gagnez du temps et améliorez la qualité du suivi
            </h2>
          </div>
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-14 px-6 lg:grid-cols-2">
          <div>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-8 inline-flex rounded-xl bg-[#FF7A00] px-6 py-3.5 font-semibold text-white transition hover:bg-[#e66e00]"
            >
          ...
          <div className="rounded-[28px] bg-[#F7F9FC] p-6 shadow-xl">
            <div className="rounded-2xl bg-white p-6">
              ...
              <div className="mt-6 flex h-56 items-end gap-3 rounded-2xl bg-slate-50 p-5">
                {[35, 48, 42, 64, 57, 74, 88, 81, 96].map(
                  (height, index) => (
                    <div
                      key={index}
      ...
      <section id="tarifs" className="bg-[#F7F9FC] py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-4 text-3xl font-bold text-[#1E2A38] sm:text-4xl">
              Choisissez l’offre adaptée à votre organisation
            </h2>
          </div>
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="rounded-[36px] bg-gradient-to-r from-[#1E2A38] to-[#00A990] px-8 py-14 text-center text-white shadow-2xl sm:px-14">
            ...
            <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-white/80">
              {sector.ctaDescription}
            </p>

            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              <a
                href={`mailto:contact@enterpriseerp.com?subject=Demande de démonstration EnterpriseERP ${sector.slug}`}
